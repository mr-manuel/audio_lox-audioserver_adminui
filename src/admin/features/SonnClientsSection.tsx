 ...
 * address, version: read-only, it told us), what it is *doing* (the status strip, live), and what it
 ...
 * on the Zones screen; this section's job ends at creating and naming it.
 */
