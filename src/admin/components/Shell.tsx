...
import BuildChannelNotice from './BuildChannelNotice';
...
export default function Shell({
  ...
  return (
    <>
      {/* Outside .shell on purpose: the shell carries a top padding that changes
          per state, and this has to sit flush against the top regardless. */}
      <BuildChannelNotice apiStatus={apiStatus} />
      <div className="shell">
